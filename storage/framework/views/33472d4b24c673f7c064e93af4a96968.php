            ...
            <tbody>
                <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="text-center border">
                        <td class="p-3"><?php echo e($comment->user->name ?? 'Usuario desconocido'); ?></td>
                        <td class="p-3"><?php echo e($comment->comment); ?></td>
                        <td class="p-3"><?php echo e($comment->space->name ?? 'Sin espacio'); ?></td>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\baleart\resources\views\comments\index.blade.php ENDPATH**/ ?>