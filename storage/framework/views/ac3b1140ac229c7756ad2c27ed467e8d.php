    ...
    <div class="container mx-auto p-6">
        ...
        <form method="GET" class="mb-4">
            ...
            <select name="sort" onchange="this.form.submit()" class="border p-2 rounded">
                ...
                <option value="created_at" <?php echo e(request('sort') == 'created_at' ? 'selected' : ''); ?>>Últimos creados</option>
                <option value="updated_at" <?php echo e(request('sort') == 'updated_at' ? 'selected' : ''); ?>>Últimos modificados</option>
            </select>
        </form>
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-center border border-gray-300 hover:bg-gray-100 transition">
                            <td class="p-3 border"><?php echo e($user->id); ?></td>
                            <td class="p-3 border"><?php echo e($user->name); ?></td>
                            <td class="p-3 border"><?php echo e($user->email); ?></td>
                            <td class="p-3 border"><?php echo e($user->created_at->format('d-m-Y H:i')); ?></td>
                            <td class="p-3 border"><?php echo e($user->updated_at->format('d-m-Y H:i')); ?></td>
                            <td class="p-3 flex justify-center gap-2">
                                <a href="<?php echo e(route('users.comments', $user)); ?>" class="bg-blue-500 text-white px-3 py-1 rounded hover:bg-blue-600 transition">Comentarios</a>
